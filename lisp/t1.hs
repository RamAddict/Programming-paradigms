...
allPossibleOptions | (maxValue == puzzleSize) = permutations [1..maxValue]
                   | otherwise =  permutations [0..(maxValue -1 )]
...
myEmpty61 :: Game
myEmpty61 = (G [(L 1 [] 0), (L 4 [] 2), (L 2 [] 0), (L 0 [] 2), (L 2 [] 2), (L 2 [] 3), (L 1 [] 0) , (L 4 [] 1), (L 4 [] 2), (L 3 [] 3), (L 2 [] 4), (L 0 [] 0)])
...
fillAllColumns esteJogo = colOperator (esteJogo) (1)
    where colOperator jogo n | (n == (puzzleSize+1)) = jogo
                             | otherwise = 
(colOperator
(writeLineG (jogo) (fillColumn n jogo) (n+puzzleSize)) (n+1))


--  Transforma linhas em uma coluna correspondente                          
fillColumn :: Int -> Game -> Linha
fillColumn n (G a) = (L (getX (getLinhaG (n+puzzleSize) (G a)))

 (operator n [getValues (getLinhaG i (G a)) | i <- [1..puzzleSize]]) 

 (getY (getLinhaG (n+puzzleSize) (G a))))
...
main = do
--print(nPredios [1,1,1,1,1])
--print(repeatsElement myCorrectLine)
--print(verificaCorretude (G []))
--print(verificaLinhaValida myCorrectLine)
--print(verificaDir 1 (reverse $ [1,2,3,4,5]))
--print(verificaDir 2 [4,5,2,1,3])
--print(verificaDir 0 (reverse $ [4,5,2,1,3]))
--print(nPredios [4,5,2,1,3])
--print(nPredios [1,2,3,4,5])
--print(nPredios [1,3,4,5,2])
--print(verificaCorretude (G [myCorrectLine]))
--print(verificaCorretude myCorrectGame)
--print(randomRIO (1, 10))
--print(preencheLinha (L 2 []))
--print(randomList mySeed 1000)
-- print(gameToMatrix myCorrectGame)
--print(getOptions (L 3 [] 2))
--print(permutations [1..5])
-- print(filterSolutions myEmptyGame)
-- print(getOptions (getLinhaG 1 myEmptyGame))
-- printGame myCorrectGame
-- print(verificaCorretude myCorrectGame)
-- printGame (fillAllColumns myCorrectGame)
-- printAllLines myHalfCorretGame
-- printAllLines (fillAllColumns myHalfCorretGame)
-- print(verificaCorretude (fillAllColumns myHalfCorretGame))
-- solveGame myEmptyGame 1
-- printAllLines myHalfCorrectGame3
-- printAllLines (fillAllColumns myHalfCorrectGame3)
-- print(allPossibleOptions)
-- print("Todas as possiveis solucoes do jogo: ")
-- printGame (fillAllColumns myHalfCorrectGame3)
solveGame myEmpty40O 1 
-- print(allPossibleOptions)
-- solveGame myEmpty50 1
-- print(allPossibleOptions)
-- print(getOptions (L 0 [] 3))
-- print(repeatsElement (L 0 [0,0,1] 0))